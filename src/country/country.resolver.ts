...
import { CountryModel, ItemCountryModel, ManyCountryModel } from "./country.model";
...
export class CountryResolver {
    ...
    @Query(() => ManyCountryModel)
    @ForAuth(2)
    async findNotAcceptedCountry(@Args() data: FindAllArgs): Promise<ManyCountryModel> {
