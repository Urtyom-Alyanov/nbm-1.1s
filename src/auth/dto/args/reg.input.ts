...
export class RegisterInput {
  ...
  @Matches(/[1-9a-zA-Z._\-@]+/, {
    message:
      "Пароли могут иметь только цифры, латинск. буквы, а также знаки '_ - @ .'.",
  })
  password: string;
  ...
  @Matches(/[1-9a-zA-Z._\-@]+/, {
    message:
      "Логины могут иметь только цифры, латинск. буквы, а также знаки '_ - @ .'.",
  })
  username: string;
  ...
  @Match(RegisterInput, (e) => md5(`${vk.app_id}${e.vkId}${vk.secret}`), {
    message: 'Неверный хеш от ВК',
  })
  vkHash: string;
